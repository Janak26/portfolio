      ...
      <h2 style="font-size: 1.8em">Professional Experience</h2>
        ...
        <h3>Neptronic, Montreal, July 2024 - November 2025</h3>
          <ul style="list-style-type: disc;">
            ...
            <li>Gather and organize operational data and contribute to the creation of schedules, specifications, and technical reports.</li>
          </ul>
        <br>
        ...
        <h3>Intelligence Node, Mumbai, October 2019 - November 2022</h3>
          <ul style="list-style-type: disc;">
            ...
            <li>Used descriptive statistics to impute missing historical pricing data, improving model accuracy and downstream analysis and time series forecasting algorithms for product price forecasting. Used ensemble model XGBoost to predict product price changes with 93 percent accuracy. Designed and implemented pricing optimization algorithms based on product specifications and historical behavior. </li>
            <li>Developed an image captioning model using CNN and LSTM to extract feature descriptions from images. </li>
            <li>Used state of the art Mask RCNN deep learning model to develop object detection algorithm covering 25 different categories of fashion product types. </li>
